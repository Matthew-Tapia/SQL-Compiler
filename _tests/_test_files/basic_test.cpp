...
const vector<string> command_list = {
    /*00*/ "create table employee fields  last,       first,         dep,      "
           "salary, year",
    /*01*/
    "insert into employee values Blow,       Joe,           CS,       100000, "
    "2018",
    /*02*/
    "insert into employee values Blow,       JoAnn,         Physics,  200000, "
    "2016",
    /*03*/
    "insert into employee values Johnson,    Jack,          HR,       150000, "
    "2014",
    /*04*/
    "insert into employee values Johnson,    \"Jimmy\",     Chemistry,140000, "
    "2018",
    ...
    /*07*/
    "insert into student values Bo, 		     Yang, 	CS, 	"
    "	28",
    /*08*/
    "insert into student values \"Sammuel L.\", Jackson, 	CS, 	"
    "	40",
    /*09*/
...
FAILED: create table: table name cannot be empty
> create table employee fields  last,       first,         dep,      salary,
year table is created

> create table employee fields  last,       first,         dep,      salary,
year FAILED: create table: employee table already exists > insert into employee
values Blow,       Joe,           CS,       100000, 2018 > insert into employee
values Blow,       JoAnn,         Physics,  200000, 2016 > insert into employee
values Johnson,    Jack,          HR,       150000, 2014 > insert into employee
values Johnson,    "Jimmy",     Chemistry,140000, 2018 > create table student
fields  fname,          lname,    major,    age > insert into student values
Flo,            Yao,       Art,    20 > insert into student values Bo, Yang, CS,
28 > insert into student values "Sammuel L.", Jackson,     CS,             40 >
insert into student values "Billy",        Jackson,   Math,   27 > insert into
student values "Mary Ann",   Davis,       Math,   30
